...
{
    public partial class AddIngredientAndRelatedModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Irritancy = table.Column<int>(type: "int", nullable: true),
                    Comedogenicity = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientFunctions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngredientFunctions_Functions_FunctionId",
                        column: x => x.FunctionId,
                        principalTable: "Functions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IngredientFunctions_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientFunctions_FunctionId",
                table: "IngredientFunctions",
                column: "FunctionId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientFunctions_IngredientId",
                table: "IngredientFunctions",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientFunctions_IsDeleted",
                table: "IngredientFunctions",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductIngredients_IsDeleted",
                table: "ProductIngredients",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_UploadedByUserId",
                table: "Products",
                column: "UploadedByUserId");
        }
